...
agent= create_agent(llm,
                    ...
                    system_prompt="You are a helpful assistant that provides weather and news information about cities. Use the provided tools to fetch the required information when asked by the user."
                    )


print("CITY INTELLIGENCE AGENT")
print("Ask me about the weather or latest news in any city! Type 'exit' to quit.")
...
while True:
    ...
    print("bot: ", result['messages'][-1].content) #This will simply print the final result of the AI message 
